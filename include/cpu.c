...
void nop();
void ld_dc_nn(int ld, int dc);
void ld_bc_a();

const instruction instructions[256] = {
	{"NOP", 0, nop}, // 0x00
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0x01
	...
	{"NOP", 0, nop}, // 0x10
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0x11
	{"LD (BC), A", 0, ld_bc_a}, // 0x12
	{}, // 0x13
	{}, // 0x14
	{}, //0x15
	{}, // 0x16
	...
	{"NOP", 0, nop}, // 0x20
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0x21
	{"LD (BC), A", 0, ld_bc_a}, // 0x22
	{}, // 0x23
	{}, // 0x24
	{}, //0x25
	{}, // 0x26
	...
	{"NOP", 0, nop}, // 0x30
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0x31
	{"LD (BC), A", 0, ld_bc_a}, // 0x32
	{}, // 0x33
	{}, // 0x34
	{}, //0x35
	{}, // 0x36
	...
	{"NOP", 0, nop}, // 0x40
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0x41
	{"LD (BC), A", 0, ld_bc_a}, // 0x42
	{}, // 0x43
	{}, // 0x44
	{}, //0x45
	{}, // 0x46
	...
	{"NOP", 0, nop}, // 0x50
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0x51
	{"LD (BC), A", 0, ld_bc_a}, // 0x52
	{}, // 0x53
	{}, // 0x54
	{}, //0x55
	{}, // 0x56
	...
	{"NOP", 0, nop}, // 0x60
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0x61
	{"LD (BC), A", 0, ld_bc_a}, // 0x62
	{}, // 0x63
	{}, // 0x64
	{}, //0x65
	{}, // 0x66
	...
	{"NOP", 0, nop}, // 0x70
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0x71
	{"LD (BC), A", 0, ld_bc_a}, // 0x72
	{}, // 0x73
	{}, // 0x74
	{}, //0x75
	{}, // 0x76
	...
	{"NOP", 0, nop}, // 0x80
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0x81
	{"LD (BC), A", 0, ld_bc_a}, // 0x82
	{}, // 0x83
	{}, // 0x84
	{}, //0x85
	{}, // 0x86
	...
	{"NOP", 0, nop}, // 0x90
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0x91
	{"LD (BC), A", 0, ld_bc_a}, // 0x92
	{}, // 0x93
	{}, // 0x94
	{}, //0x95
	{}, // 0x96
	...
	{"NOP", 0, nop}, // 0xa0
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0xa1
	{"LD (BC), A", 0, ld_bc_a}, // 0xa2
	{}, // 0xa3
	{}, // 0xa4
	{}, //0xa5
	{}, // 0xa6
	...
	{"NOP", 0, nop}, // 0xb0
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0xb1
	{"LD (BC), A", 0, ld_bc_a}, // 0xb2
	{}, // 0xb3
	{}, // 0xb4
	{}, //0xb5
	{}, // 0xb6
	...
	{"NOP", 0, nop}, // 0xc0
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0xc1
	{"LD (BC), A", 0, ld_bc_a}, // 0xc2
	{}, // 0xc3
	{}, // 0xc4
	{}, //0xc5
	{}, // 0xc6
	...
	{"NOP", 0, nop}, // 0xd0
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0xd1
	{"LD (BC), A", 0, ld_bc_a}, // 0xd2
	{}, // 0xd3
	{}, // 0xd4
	{}, //0xd5
	{}, // 0xd6
	...
	{"NOP", 0, nop}, // 0xe0
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0xe1
	{"LD (BC), A", 0, ld_bc_a}, // 0xe2
	{}, // 0xe3
	{}, // 0xe4
	{}, //0xe5
	{}, // 0xe6
	...
	{"NOP", 0, nop}, // 0xf0
	{"LD DC, %d%d", 2, ld_dc_nn}, // 0xf1
	{"LD (BC), A", 0, ld_bc_a}, // 0xf2
	{}, // 0xf3
	{}, // 0xf4
	{}, //0xf5
	{}, // 0xf6
...
void cpuStep(void) {
	...
	if(instructions[instruction].operandLength == 1) operand = (u_short)readByte(registers.pc);
